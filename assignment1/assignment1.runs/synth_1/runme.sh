...
HD_PWD='F:/0_MYHOMEWORK/33_CE339/assignment1/assignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main3_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main3_final.tcl
