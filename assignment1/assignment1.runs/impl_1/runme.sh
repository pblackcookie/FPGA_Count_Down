...
HD_PWD='F:/0_MYHOMEWORK/33_CE339/assignment1/assignment1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main3_final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main3_final.tcl -notrace
